...
import { Dumbbell, Calendar, ChevronDown, ChevronUp, Clock, Flame, TrendingUp } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="border-b bg-card px-4 sm:px-6 py-4">
        ...
        <p className="text-sm text-muted-foreground">Planos de treino de {patientName}</p>
      </header>
